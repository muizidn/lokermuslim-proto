...
public protocol Loker_AuthService {
  ...
  func registerPekerja(_ request: Loker_PekerjaRegisterRequest, callOptions: CallOptions?) -> UnaryCall<Loker_PekerjaRegisterRequest, Loker_RespMessage>
  func registerPerusahaan(_ request: Loker_PerusahaanRegisterRequest, callOptions: CallOptions?) -> UnaryCall<Loker_PerusahaanRegisterRequest, Loker_RespMessage>
}
...
public final class Loker_AuthServiceClient: GRPCClient, Loker_AuthService {
  ...
  ///   - callOptions: Call options; `self.defaultCallOptions` is used if `nil`.
  /// - Returns: A `UnaryCall` with futures for the metadata, status and response.
  public func registerPekerja(_ request: Loker_PekerjaRegisterRequest, callOptions: CallOptions? = nil) -> UnaryCall<Loker_PekerjaRegisterRequest, Loker_RespMessage> {
  ...
  ///   - callOptions: Call options; `self.defaultCallOptions` is used if `nil`.
  /// - Returns: A `UnaryCall` with futures for the metadata, status and response.
  public func registerPerusahaan(_ request: Loker_PerusahaanRegisterRequest, callOptions: CallOptions? = nil) -> UnaryCall<Loker_PerusahaanRegisterRequest, Loker_RespMessage> {
...
public protocol Loker_AuthProvider: CallHandlerProvider {
  ...
  func registerPekerja(request: Loker_PekerjaRegisterRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Loker_RespMessage>
  func registerPerusahaan(request: Loker_PerusahaanRegisterRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Loker_RespMessage>
}
